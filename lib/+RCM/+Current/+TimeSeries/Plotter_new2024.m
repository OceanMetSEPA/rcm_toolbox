classdef (Abstract) Plotter_new2024 < handle
    ...
    methods
        function h = scatterPlot(TS)
            ...
            h = RCM.Current.TimeSeries_new2024.componentScatterPlot(TS.u, TS.v, 'majorAxis', TS.MajorAxis, 'legend', legend);
        end
        ...
        function h =normalisedScatterPlot(TS, name, depth)
            ...
            h = RCM.Current.TimeSeries_new2024.componentScatterPlot(TS.NormalComponent, TS.ParallelComponent, 'title', [name,', normalised currents - ', depth, ' m above bed'], 'legend', legend);
        end
