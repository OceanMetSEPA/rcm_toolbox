classdef TimeSeries_new2024 < RCM.TimeSeries.TotalTide ... % Abstract classes first
        & RCM.Current.TimeSeries.Plotter_new2024 ...
        & RCM.TimeSeries.Base
    ...
    methods(Static = true)
        ...
        function TS = create(time, speed, direction, varargin)
            TS = RCM.Current.TimeSeries_new2024;
        ...
        function TS = fromHGAnalysisXls(path, varargin)
            ...
            [l,w] = size(allData);
            settingsTable=allData(1:12,1:2);
            ...
            data.BinType = settingsTable{7,2};
            data.BinNo = cell2mat(settingsTable{8,2});
            data.BinHeight = cell2mat(settingsTable{9,2});
            data.WaterDepth = cell2mat(settingsTable{10,2});
            data.InstrumentModel = settingsTable{11,2};
            data.InstrumentSerial = cell2mat(settingsTable{12,2});
            ...
            TS = RCM.Current.TimeSeries_new2024.create(data.DateTime,data.Speed,data.Direction);
        ...
        function ts = fromStruct(s, varargin)
            ts = RCM.Current.TimeSeries_new2024.create(s.Time, s.Speed, s.Direction);
